...
# Tools
* The core for now is https://github.com/molly/static-timeline-generator though I have at least one idea of how I want to extend it.
* I will use Claude Code as part of my development stack for this project. I can say with confidence that the project would not get done otherwise. If it bothers you you're welcome to fork the project or ignore it.

# Inspirations
* The OG: https://www.mollywhite.net/timelines/wikimedia/
